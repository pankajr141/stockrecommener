...
def display():
    ...
    st.title('ETF Analysis - diff strategies')
    log.info('Analyzing portfolios')

    df_etf_stats = analyze.find_etf_statistics()
    st.bar_chart(df_etf_stats, x="year", y="profit")

    # st.write(df_etf_stats)
    # info = {}
